...
var JwtSecretId = Symbol('JwtSecretId');
var JwtStrategy = /** @class */ (function (_super) {
    __extends(JwtStrategy, _super);
    function JwtStrategy(jwtSecret) {
        var _this = this;
        var strategyOptions = {
            jwtFromRequest: passport_jwt_1.ExtractJwt.fromAuthHeaderAsBearerToken(),
            ignoreExpiration: false,
            secretOrKey: jwt_constants_1.jwtConstants.JWT_SECRET
        };
        _this = _super.call(this, strategyOptions) || this;
        return _this;
    }
    /**
    ...
    JwtStrategy = __decorate([
        common_1.Injectable(),
        __param(0, common_1.Inject(JwtSecretId))
    ], JwtStrategy);
    return JwtStrategy;
